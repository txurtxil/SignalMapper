...
echo "🔧 1/2 Extirpando el maldito 'const' de la capa forense..."
...
echo "🚀 2/2 Compilando SM Audit (V24.3) limpia..."
flutter build apk --profile

if [ -f "build/app/outputs/flutter-apk/app-profile.apk" ]; then
    gh release create v24.3-anomalies-fix build/app/outputs/flutter-apk/app-profile.apk --repo txurtxil/SignalMapper --title "🛡️ SM AUDIT V24.3: CONST KILLER" --notes "Eliminado const conflictivo. Motor de detección de Handover funcional."
    echo "===================================================="
    echo "✅ ¡COMPILADO!"
    echo "===================================================="
else
